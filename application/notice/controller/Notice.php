...
//        $result = $this->class->index();
    ...
    {
        //视图
        return $this->class->view('notice', ['type' => 'create']);
    }
    ...
    public function save()
    {
        ...
        //反馈成功
        return $this->class->success('/notice');
    }
    ...
    public function read($id)
    {
        ...
        //视图
        return $this->class->view('notice', ['notice' => $model]);
    }
    ...
    public function edit($id)
    {
        ...
        //视图
        return $this->class->view('notice', ['notice' => $result, 'type' => 'edit']);
    }
